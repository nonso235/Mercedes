...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Mercedes~lBYzRQyR#bkKZH48efTBPjL_c4xuoiNIWsUIqz2TSSmehsc5m_e8",
// add your Session Id 
...
STICKER_NAME: process.env.STICKER_NAME || "Him md",
...
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*Made By Him*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/avqa3c.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> *Him Made It*",
// add alive msg here 
